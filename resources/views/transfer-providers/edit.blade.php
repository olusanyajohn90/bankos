<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="font-bold text-xl text-bankos-text dark:text-bankos-dark-text leading-tight">Edit Transfer Provider</h2>
                <p class="text-sm text-bankos-text-sec mt-1">{{ $provider->name }} ({{ $provider->code }})</p>
            </div>
        </div>
    </x-slot>

    <div class="max-w-3xl">
        <form method="POST" action="{{ route('transfer-providers.update', $provider) }}" class="card p-6 space-y-6">
            @csrf
            @method('PATCH')
            ...
            <div class="border-b border-bankos-border pb-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="flex flex-col gap-1 md:col-span-2">
                        ...
                        <input type="text" id="provider_class" name="provider_class" value="{{ old('provider_class', $provider->provider_class) }}"
                    ...
                    <div class="flex flex-col gap-1 md:col-span-2">
                        ...
                        <textarea id="config" name="config" rows="4"
                                  ...
                                  class="form-input font-mono text-sm @error('config') border-red-500 @enderror">{{ old('config', $provider->config ? json_encode($provider->config, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) : '') }}</textarea>
            ...
            <div class="border-b border-bankos-border pb-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="number" id="priority" name="priority" value="{{ old('priority', $provider->priority) }}"
            ...
            <div class="border-b border-bankos-border pb-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="number" id="min_amount" name="min_amount" value="{{ old('min_amount', $provider->min_amount) }}"
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="number" id="max_amount" name="max_amount" value="{{ old('max_amount', $provider->max_amount) }}"
            ...
            <div class="pb-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="number" id="flat_fee" name="flat_fee" value="{{ old('flat_fee', $provider->flat_fee) }}"
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="number" id="percentage_fee" name="percentage_fee" value="{{ old('percentage_fee', $provider->percentage_fee) }}"
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="number" id="fee_cap" name="fee_cap" value="{{ old('fee_cap', $provider->fee_cap) }}"
