        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="font-bold text-xl text-bankos-text dark:text-bankos-dark-text leading-tight">
                    Edit Custom Role: {{ ucwords(str_replace('_', ' ', $role->name)) }}
                </h2>
                <p class="text-sm text-bankos-text-sec mt-1">Modify this role's name and assigned system permissions</p>
            </div>
        </div>
    </x-slot>
        ...
        <form action="{{ route('roles.update', $role) }}" method="POST" class="space-y-8">
            ...
            <div class="space-y-4">
                ...
                <div class="max-w-md">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $role->name) }}" class="form-input" required placeholder="e.g. Call Center Agent">
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div class="flex justify-between items-end border-b border-gray-100 dark:border-gray-800 pb-2">
                    ...
                    <p class="text-xs text-bankos-text-sec">Check or uncheck the boxes to adjust access levels.</p>
                </div>
