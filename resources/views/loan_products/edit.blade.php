<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto card p-8">
        <form action="{{ route('loan-products.update', $loanProduct) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="name" value="{{ old('name', $loanProduct->name) }}" class="form-input w-full" placeholder="e.g. Personal Unsecured Loan" required>
                </div>

                <div>
                    <label class="block text-sm font-medium text-bankos-text-sec mb-2">Product Code <span class="text-red-500">*</span></label>
                    <input type="text" name="code" value="{{ old('code', $loanProduct->code) }}" class="form-input w-full font-mono uppercase" placeholder="e.g. LNP-PER" required>
                </div>

                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-bankos-text-sec mb-2">Product Description</label>
                    <textarea name="description" class="form-input w-full" rows="2">{{ old('description', $loanProduct->description) }}</textarea>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex">
                        <input type="number" step="0.01" name="interest_rate" value="{{ old('interest_rate', $loanProduct->interest_rate) }}" class="form-input rounded-r-none w-2/3 border-r-0 focus:ring-0 focus:border-bankos-primary" placeholder="e.g. 5.5" required>
                        <select name="interest_type" class="form-select rounded-l-none bg-gray-50 border-l-0 w-1/3">
                            ...
                            <option value="reducing_balance" {{ old('interest_type', $loanProduct->interest_type) == 'reducing_balance' ? 'selected' : '' }}>% (Reducing Bal)</option>
                        </select>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" name="min_amount" value="{{ old('min_amount', $loanProduct->min_amount) }}" class="form-input pl-8 w-full" required>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-bankos-muted">₦</div>
                        <input type="number" step="0.01" name="max_amount" value="{{ old('max_amount', $loanProduct->max_amount) }}" class="form-input pl-8 w-full" required>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="min_duration" value="{{ old('min_duration', $loanProduct->min_duration) }}" class="form-input w-full" required>
                </div>

                <div>
                    <label class="block text-sm font-medium text-bankos-text-sec mb-2">Max Duration <span class="text-red-500">*</span></label>
                    <input type="number" name="max_duration" value="{{ old('max_duration', $loanProduct->max_duration) }}" class="form-input w-full" required>
                </div>
                ...
                <div>
                    ...
                    <select name="duration_type" class="form-select w-full" required>
                        <option value="months" {{ old('duration_type', $loanProduct->duration_type) == 'months' ? 'selected' : '' }}>Months</option>
                        <option value="days" {{ old('duration_type', $loanProduct->duration_type) == 'days' ? 'selected' : '' }}>Days</option>
                        <option value="weeks" {{ old('duration_type', $loanProduct->duration_type) == 'weeks' ? 'selected' : '' }}>Weeks</option>
                        <option value="years" {{ old('duration_type', $loanProduct->duration_type) == 'years' ? 'selected' : '' }}>Years</option>
                    </select>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <input type="checkbox" name="requires_collateral" value="1" id="req_col" class="rounded border-bankos-border text-bankos-primary focus:ring-bankos-primary" {{ old('requires_collateral', $loanProduct->requires_collateral) ? 'checked' : '' }}>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <input type="checkbox" name="require_guarantor" value="1" id="req_gua" class="rounded border-bankos-border text-bankos-primary focus:ring-bankos-primary" {{ old('require_guarantor', $loanProduct->require_guarantor) ? 'checked' : '' }}>
                ...
                <div>
                    ...
                    <input type="number" step="0.1" name="max_dti_ratio" value="{{ old('max_dti_ratio', $loanProduct->max_dti_ratio) }}" class="form-input w-full" required>
